...
const footerLinks = [
  {
    ...
    links: [
      ...
      { label: "Africa", href: "/explore?continent=africa" },
      { label: "Asia", href: "/explore?continent=asia" },
      { label: "Europe", href: "/explore?continent=europe" },
    ],
  },
  {
    heading: "For Guides",
    links: [
      ...
      { label: "How It Works", href: "/about#guides" },
    ],
  },
  {
    heading: "Company",
    ...
    <footer className="border-t border-slate-100 bg-white px-4 py-12 md:px-8">
      <div className="mx-auto max-w-5xl">
        <div className="grid grid-cols-2 gap-10 md:grid-cols-5">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="mt-4 flex gap-3">
              {socialLinks.map(({ label, path, viewBox }) => (
                <a
                  key={label}
                  href="#"
                  aria-label={label}
                ...
                >
                  <svg viewBox={viewBox} className="size-4" fill="currentColor" aria-hidden>
                    <path d={path} />
                  </svg>
                </a>
              ))}
        ...
        <div className="mt-10 border-t border-slate-100 pt-6 text-center text-xs text-slate-400">
          &copy; {year} Straight2Guide. All rights reserved.
        </div>
      </div>
    </footer>
  );
